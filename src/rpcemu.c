...
const Model_Details models[] = {
	...
	{ "Risc PC - StrongARM (SA-1110 compat) (experimental)", "RPCSA1110", CPUModel_SA1110, IOMDType_IOMD, SuperIOType_FDC37C665GT, I2C_PCF8583 }
};
...
rpcemu_config_apply_new_settings(Config *new_config, Model new_model)
{
	...
	/* Phoebe (RPC2) now honours the user-selected RAM and VRAM sizes rather
	   than forcing fixed values, so no override is applied here. */
